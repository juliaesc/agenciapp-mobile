...
const config = {
  issuer: 'https://dev-534787.oktapreview.com/oauth2/default',
  clientId: '0oag9lpj33Kme6OYb0h7',
  redirectUrl: 'com.oktapreview.dev-534787:/callback',
    ...
    return (
      <Page>
        ...
        <ButtonContainer>
          ...
          {!!state.accessToken &&
            <Button
              onPress={this.fetchGoodBeers}
              text={!this.state.beers.length ? 'Good Beers' : 'ID Token'}
              color="#008000"
            />
          }
        </ButtonContainer>
